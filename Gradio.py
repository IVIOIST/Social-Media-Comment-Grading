...
def score_comment(comment):
    ...
    text = ''
    plt.bar(labels_list, prediction[0], color='teal', width=0.4)
...
interface = gr.Interface(fn=score_comment, inputs=gr.inputs.Textbox(lines=2, placeholder='Comment to score'),outputs=['text', 'plot'])
